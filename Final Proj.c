...
void intro() //provides the introduction of the game.
{
	...
	printf("\n\n_______________________________________BEST OF LUCK______________________________________________________________________");
}
